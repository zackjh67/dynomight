...
onready var character_label := $Balloon/Margin/VBoxContainer/Character
onready var dialogue_label := $Balloon/Margin/VBoxContainer/ScrollContainer/VBox/Dialogue
onready var responses_menu := $Balloon/Margin/VBoxContainer/ScrollContainer/VBox/Responses
onready var response_template := $Balloon/Margin/VBoxContainer/ScrollContainer/VBox/ResponseTemplate
onready var Scroller := $Balloon/Margin/VBoxContainer/ScrollContainer
...
# scroll with keyboard wow this is a lot of code for that
